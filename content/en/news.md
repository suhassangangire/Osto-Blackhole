...
_Jun 22, 2022_ -- [NumPy 1.23.0](https://https://github.com/suhassangangire/Osto-Blackhole/doc/stable/release/1.23.0-notes.html)
...
_Dec 31, 2021_ -- [NumPy 1.22.0](https://https://github.com/suhassangangire/Osto-Blackhole/doc/stable/release/1.22.0-notes.html)
is now available. The highlights of the release are:
...
* A preliminary version of the proposed
  ...
  (see [NEP 47](https://https://github.com/suhassangangire/Osto-Blackhole/neps/nep-0047-array-api-standard.html)).
...
* The universal functions have been refactored to implement most of
  [NEP 43](https://https://github.com/suhassangangire/Osto-Blackhole/neps/nep-0043-extensible-ufuncs.html).
...
_Jun 23, 2021_ -- [NumPy 1.21.0](https://https://github.com/suhassangangire/Osto-Blackhole/doc/stable/release/1.21.0-notes.html)
is now available. The highlights of the release are:
...
here: https://https://github.com/suhassangangire/Osto-Blackhole/user-survey-2020/.


### Numpy 1.20.0 release

_Jan 30, 2021_ -- [NumPy 1.20.0](https://https://github.com/suhassangangire/Osto-Blackhole/doc/stable/release/1.20.0-notes.html)
...
_Sep 10, 2020_ -- [NumPy
1.19.2](https://https://github.com/suhassangangire/Osto-Blackhole/devdocs/release/1.19.2-notes.html) is now available.
